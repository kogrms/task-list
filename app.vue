<template>
  <div
    class="relative flex flex-col justify-center items-center w-screen h-[100dvh] overflow-y-auto"
  ...
  >
    ...
    <div class="absolute inset-0 bg-black opacity-0 dark:opacity-30 pointer-events-none w-full h-full z-10" />
    ...
    <div class="relative z-20 flex flex-col items-center w-[95vw] max-w-[730px] min-h-[500px] md:min-h-[719px] bg-white dark:bg-grey-20 rounded-3xl px-4 py-6 sm:py-8">
      ...
      <img
        ...
        class="w-[180px] max-w-1/3 md:max-w-[180px] dark:opacity-80"
      >

      <h1 class="text-3xl font-bold text-center py-4 sm:py-12">
        Today I need to
      </h1>
      ...
      <div
        ...
        class="flex items-center justify-center gap-2 mt-auto flex-wrap"
      >
        <svgo-checkmark
          ...
          :filled="true"
        />
        <p class="text-t12 sm:text-t14 text-grey-8f text-center">
