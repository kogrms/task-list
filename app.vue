<template>
  ...
  >
    <div class="flex flex-col items-center w-[95vw] max-w-[730px] min-h-[500px] md:min-h-[719px] bg-white dark:bg-grey-20 rounded-3xl px-4 py-4 sm:py-8">
      <img src="~assets/images/illustration.png" class="w-[180px] max-w-1/3 md:max-w-[180px] h-auto"/>
      ...
      <div v-else class="flex items-center justify-center gap-2 mt-auto flex-wrap">
        <img src="~assets/images/checkmark.svg" class="w-4 h-4 sm:w-6 sm:h-6"/>
